...
Making in-between states feel intentional with ViewTransition. Every animation here works with the transition system we've already set up — `startTransition`, `useOptimistic`, `useDeferredValue`.
