...
- The label filter pills use ChipGroup — same idea. Change to `action`, and now clicking "React" or "Performance" highlights the pill right away while the filtered grid loads.
